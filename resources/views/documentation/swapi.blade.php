...
```
{{env('SWAPI_URL')}}people?filter[name]=luke
```
...
Content-Type: application/json
{
    "films": "{{env('SWAPI_URL')}}films",
    "people": "{{env('SWAPI_URL')}}people",
    "planets": "{{env('SWAPI_URL')}}planets",
    "species": "{{env('SWAPI_URL')}}species",
    "starships": "{{env('SWAPI_URL')}}starships",
    "vehicles": "{{env('SWAPI_URL')}}vehicles"
}
```
...
```
http {{env('SWAPI_URL')}}starships/21
```
...
```
http {{env('SWAPI_URL')}}transport/4/
```
